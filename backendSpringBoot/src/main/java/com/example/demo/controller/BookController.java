...
public class BookController {
    private final BookRepository bookRepo; private final ExemplarRepository exemplarRepo;
    ...
    public List<BookDto> all(){
        return bookRepo.findAll().stream().map(b -> {
            ...
            int available = (int)exemplarRepo.countByBookIdAndStatus(b.getId(), com.example.demo.model.ExemplarStatus.AVAILABLE);
    ...
    public com.example.demo.dto.ExemplarDto addExemplar(@PathVariable Long bookId, @RequestBody com.example.demo.model.Exemplar ex) {
        ...
        ex.setBook(b); ex.setStatus(com.example.demo.model.ExemplarStatus.AVAILABLE);
